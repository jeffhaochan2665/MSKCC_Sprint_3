...
import com.wolfsoft.one.bronzeapp.CardController;
import com.wolfsoft.one.bronzeapp.R;


public class EmotionChart extends CardController {
...
//    private final TextView mLegendOneGreen;
    ...
    private final float [][] mValuesOne = {
            {03f, 40f, 25f, 25f, 11f, 25f, 25f},
            {15f, 12f, 25f, 40f, 2f, 30f, 40f},
            {30f, 3f, 25f, 25f, 20f, 25f, 25f}};


    public EmotionChart(CardView card){
        super(card);
